...
type result = Tie | Zmaga of player
...
let place_token player grid (row_i, col_i) x : state =
  ...
  | Some player ->
      ...
      zmagovalcem *)
      GameOver {result = Zmaga player; final_grid = updated_grid}
